...
goog.require("cljs.core");
var scene_5098 = new THREE.Scene;
var width_5099 = window.innerWidth;
var height_5100 = window.innerHeight;
var view_angle_5101 = 45;
var near_5102 = 0.1;
var far_5103 = 1E4;
var camera_5104 = new THREE.PerspectiveCamera(view_angle_5101, width_5099 / height_5100, near_5102, far_5103);
var controls_5105 = new THREE.FlyControls(camera_5104);
var clock_5106 = new THREE.Clock;
var container_5107 = document.body;
crowc.render.on_window_resize = function on_window_resize() {
  var vec__5095 = cljs.core._EQ_.call(null, container_5107, document.body) ? cljs.core.PersistentVector.fromArray([window.innerWidth, window.innerHeight], true) : cljs.core.PersistentVector.fromArray([containeroffsetWidth, containeroffsetHeight], true);
  var width__$1 = cljs.core.nth.call(null, vec__5095, 0, null);
  var height__$1 = cljs.core.nth.call(null, vec__5095, 1, null);
  crowc.render.renderer.setSize(width__$1, height__$1);
  camera_5104.aspect = width__$1 / height__$1;
  camera_5104.radius = (width__$1 + height__$1) / 4;
  return camera_5104.updateProjectionMatrix()
};
crowc.render.create = function create(canvas) {
  if(cljs.core.truth_(Detector.webgl)) {
    ...
    (function render_callback() {
      var delta_5108 = clock_5106.getDelta();
      controls_5105.update(delta_5108);
      renderer.render(scene_5098, camera_5104);
...
crowc.render.controls = function controls() {
  var G__5097_5109 = controls;
  G__5097_5109["domElement"] = crowc.render.renderer;
  G__5097_5109["movementSpeed"] = 0.1;
  G__5097_5109["rollSpeed"] = 0.1;
  G__5097_5109["autoForward"] = true;
  G__5097_5109["dragToLook"] = true;
  return camera_5104.position.z = 10
};
crowc.render.add_mesh = function add_mesh() {
  ...
  var n__4081__auto___5110 = geometry.vertices.length;
  var i_5111 = 0;
  while(true) {
    if(i_5111 < n__4081__auto___5110) {
      geometry.vertices[i_5111].z = cljs.core.rand.call(null);
      var G__5112 = i_5111 + 1;
      i_5111 = G__5112;
      continue
    }else {
    }
  ...
  return scene_5098.add(mesh)
};
crowc.render.set_camera = function set_camera(z) {
  return camera_5104.position.z = z
};
